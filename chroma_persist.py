...
chroma_client = chromadb.PersistentClient(path="./chroma_persist_data")
collection_name = "test_collection"
collection = chroma_client.get_or_create_collection(name=collection_name, embedding_function=DefaultEmbeddingFunction())
